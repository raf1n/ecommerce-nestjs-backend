...
export class PopularCategoriesController {
  constructor(private readonly popularCategoriesService: PopularCategoriesService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePopularCategoryDto: UpdatePopularCategoryDto) {
